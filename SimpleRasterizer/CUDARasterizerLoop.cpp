...
void CUDARasterizerLoop::LoadAssets() {
    ...
    TexturedVertex triangleVertices[] =
    {
    ...
    {
        const UINT trianglesSize = sizeof(TexturedVertex) * 4;
        ...
        m_texturedBufferView.StrideInBytes = sizeof(TexturedVertex);
        ...
        //AllocateFrameBuffer(m_width, m_height);
        ...
        //    Device::Streams[m_frameIndex], 1.0f, m_frameIndex);
        ...
        //Device::DX12Device->CreateShaderResourceView(m_textureBuffer.Get(), &SRVDesc, m_textureHeap->GetCPUDescriptorHandleForHeapStart());
